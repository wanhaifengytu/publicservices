...
public class Application {
    ...
    private static final String HOST1 = "10.116.28.152";
    private static final String HOST2 = "10.116.29.96";
    private static final String HOST3 = "10.116.31.203";
    ...
    private static synchronized RestHighLevelClient makeConnection() {
        ...
        if(restHighLevelClient == null) {
            restHighLevelClient = new RestHighLevelClient(
                    RestClient.builder(
                            new HttpHost(HOST1, PORT_ONE, SCHEME),
                            new HttpHost(HOST2, PORT_ONE, SCHEME),
                            new HttpHost(HOST3, PORT_ONE, SCHEME)));
        }
