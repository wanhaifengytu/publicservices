...
public class HBaseSimpleTest {
	...
	public HBaseSimpleTest() {
		System.out.println("To initialize conf ");
	...
	public static void main(String[] args) throws Exception {
		...
		HBaseSimpleTest simpleTest = new HBaseSimpleTest();
		
		String tableName = "blog2";
		String[] family = { "article", "author" };
		
		simpleTest.creatTable(tableName, family);
		...
		simpleTest.addData("rowkey1", "blog2", column1, value1, column2, value2);
		simpleTest.addData("rowkey2", "blog2", column1, value1, column2, value2);
		simpleTest.addData("rowkey3", "blog2", column1, value1, column2, value2);
