...
public class AreaTop3ProductSpark {
	...
	private static void generateTempAreaPrdocutClickCountTable(SQLContext sqlContext) {
		...
		// + "product_id_area,"
		// + "count(*) click_count,"
		// + "group_concat_distinct(concat_long_string(city_id,city_name,':'))
		// city_infos "
		// + "FROM ( "
		// + "SELECT "
		// + "random_prefix(concat_long_string(product_id,area,':'), 10)
		// product_id_area,"
		// + "city_id,"
		// + "city_name "
	...
	private static void generateTempAreaFullProductClickCountTable(SQLContext sqlContext) {
		...
		// area, product_id, click_count, city_infos, product_name,
		// product_status
		...
		// JavaRDD<Row> rdd = sqlContext.sql("select * from
		// product_info").javaRDD();
		...
		// DataTypes.createStructField("product_id", DataTypes.StringType,
		// true),
		// DataTypes.createStructField("product_name", DataTypes.StringType,
		// true),
		// DataTypes.createStructField("product_status", DataTypes.StringType,
		// true)));
		//
